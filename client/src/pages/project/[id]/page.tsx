...
import { SAMPLE_PROJECT } from "@/pages/sample/page"
...
const [match, params] = useRoute("/project/:id")
  console.log(SAMPLE_PROJECT.id,'this is ');
  
  const [project, setProject] = useState<Project | null>(SAMPLE_PROJECT.id === params!.id ? SAMPLE_PROJECT : null)
...
const [, setLocation] = useLocation()
  ...
  useEffect(() => {
    ...
    const stored =SAMPLE_PROJECT.id === params!.id ? JSON.stringify([SAMPLE_PROJECT]) : localStorage.getItem("blueprints")
    if (stored) {
